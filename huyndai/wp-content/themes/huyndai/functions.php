...
function twentysixteen_setup() {
	...
	set_post_thumbnail_size( 566, 251,true );
...
function twentysixteen_scripts() {
	...
	*/
	...
	wp_enqueue_script( 'owl-carousel-script', get_template_directory_uri() . '/js/owl.carousel.min.js', array( 'jquery' ), '20151204', true );
	wp_enqueue_style( 'owl-carousel', get_template_directory_uri() . '/css/owl.carousel.css', array( 'twentysixteen-style' ), '20150930' );
	wp_enqueue_style( 'owl-theme', get_template_directory_uri() . '/css/owl.theme.css', array( 'twentysixteen-style' ), '20150930' );
	wp_enqueue_style( 'owl-transition', get_template_directory_uri() . '/css/owl.transitions.css', array( 'twentysixteen-style' ), '20150930' );
	...
	//Add google map js
	wp_enqueue_script( 'google-map', 'https://maps.googleapis.com/maps/api/js?key=AIzaSyBi9KZruuoyo3xx6w30iy2IV2qk-JpmlD4', array( 'jquery' ), '20151204', true );
	
	//Add font awesome
	wp_enqueue_style( 'font-awesome', get_template_directory_uri() . '/css/font-awesome.min.css', array( 'twentysixteen-style' ), '20150930' );
	//Bootstrap
	wp_enqueue_style( 'bootstrap', get_template_directory_uri() . '/css/bootstrap.min.css', array( 'twentysixteen-style' ), '20150930' );
	
	
	// Theme stylesheet (main style).
	wp_enqueue_style( 'twentysixteen-style', get_stylesheet_uri() );
	wp_enqueue_script( 'basic-funcs', get_template_directory_uri() . '/js/functions.js', array( 'jquery' ), '20151204', true );
	wp_enqueue_script( 'autonumber', get_template_directory_uri() . '/js/autoNumeric.js', array( 'jquery' ), '20151204', true );
}
...
function ajax_script(){
	wp_enqueue_script( 'ajax-file', url.'/js/ajax2.js', array('jquery'), '20151229', true );	
