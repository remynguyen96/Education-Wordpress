...
<?php
	...
	$grid->add_php_col(' echo "<div class=\'arrow_from\'><a target=\'_blank\' href=\'" . SEOR_make_absolute_url($db_rfrom) ."\'>" .SR_cut_string($db_rfrom,0,120) ."</a></div><div class=\'arrow_to\'><a target=\'_blank\' href=\'" . SEOR_make_absolute_url($db_rto) ."\'>" .SR_cut_string($db_rto,0,120) ."</a></div>" ;','Redirection');
