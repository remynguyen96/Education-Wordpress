        ...
        <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 all_single_product">
            ...
            ?>  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                ...
                <div class="info1_single">
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                        <div class="img_single_product">
                            ...
                            <div class="grallery_img">
                                <?php foreach (get_post_meta(get_the_ID(),'wpcf-grallery_img',false) as $img): ?>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 ">
                        <div class="filed_service_all">
                            <div class="filed_first">
                                <span>Year :</span>
                                <div><?php echo get_post_meta(get_the_ID(),'wpcf-year',true) ?></div>
                            </div>
                            <div class="filed_service">
                                <span>Designed by :</span>
                                <div><?php echo get_post_meta(get_the_ID(),'wpcf-design-by',true) ?></div>
                            </div>
                            <div class="filed_service">
                                <span>Hole :</span>
                                <div><?php echo get_post_meta(get_the_ID(),'wpcf-hole',true) ?></div>
                            </div>
                            <div class="filed_service">
                                <span>Par / Yard :</span>
                                <div><?php echo get_post_meta(get_the_ID(),'wpcf-par-yard',true) ?></div>
                            </div>
                            <div class="filed_service">
                                <span>Near by :</span>
                                <div><?php echo get_post_meta(get_the_ID(),'wpcf-near-by',true) ?></div>
                            </div>
                            <div class="filed_special">
                        ...
                        <div class="contact_single_tee">
                            <h4>CONTACT TO GET THE PRICE</h4>
                            <p><i class="fa fa-phone"></i><span>012 345 6789 - 098 765 4321</span></p>
                            <p><i class="fa fa-envelope"></i><span>info@unigolf.vn</span></p>
                        </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 all_move_single">
                    <div class="ltineracy" id="ltineracy">
                        <div class="info_move info_move2">
                            <a href="#ltineracy" class="a_ltineracy">Golf description</a>
                            <a href="#golf_cours" class="">Video</a>
                    ...
                    <div class="golf_cours" id="golf_cours">
                        <div class="info_move info_move2">
                            ...
                            <a href="#golf_cours" class="a_golf_cours">Video</a>
                            <a href="#hotel_facilities" class="">Facilities</a>
                            <a href="#address_map" class="">Maps</a>
                            <a href="#comment" class="">Write a review</a>
                        </div>
